...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://shikara-stories.lonexain4.workers.dev/" },
      { property: "og:image", content: "https://shikara-stories.lonexain4.workers.dev/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:site_name", content: "Talib's Tour & Travels" },
      ...
      { name: "twitter:image", content: "https://shikara-stories.lonexain4.workers.dev/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://shikara-stories.lonexain4.workers.dev/" },
      { rel: "icon", href: "/talib-logo.png", type: "image/png" },
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;0,700;0,800;1,500;1,700&family=Inter:wght@300;400;500;600;700;800&display=swap",
      },
    ],
  }),
